...
const { formatDateTime, formatDate, formatTime } = require('./utils/dateUtils');
const { getStatusClass, getStatusBadgeClass, getStatusText } = require('./utils/appointmentUtils');
